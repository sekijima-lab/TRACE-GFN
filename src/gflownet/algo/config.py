...
class AlgoConfig:
    ...
    num_template_sampling: int = 50
    inf_max_len:int = 256
    beam_width:int = 50
    beam_nbest:int = 50
    # beam_templates:int = 50
    sampling_method:str = 'beam_search'
    gen_patience:int = 0
    gen_nbest:int = 10
    prob_sampling_size:int = 512
    ...
    tb: TBConfig = field(default_factory=TBConfig)  # default_factoryを使用
