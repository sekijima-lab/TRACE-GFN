...
def main():
    ...
    src_train_path = f'{cfg.USPTO_path}/src_train.txt'
    tgt_train_path = f'{cfg.USPTO_path}/tgt_train.txt'
    src_valid_path = f'{cfg.USPTO_path}/src_valid.txt'
    tgt_valid_path = f'{cfg.USPTO_path}/tgt_valid.txt'
    ...
    torch.save(v, pathlib.Path(__file__).parent / 'data' / 'vocab.pth')
    print('done.')
